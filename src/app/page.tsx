...
export default function Home() {
  return (
    <main className="text-white pt-[60px] px-5">
      <div className="pt-12 pb-20 flex flex-col items-center gap-12">
        ...
        <hgroup className="text-5xl font-bold text-center leading-[58px]">
          <h1>Hey, I'm Daniel.</h1>
          <h1>I'm a Designer & Developer.</h1>
        </hgroup>
        <p className="text-white/50 text-center leading-7">
      ...
      <div
        className="flex flex-col items-center gap-10 rounded-[20px] p-8 border border-white/15"
        style={{
          background:
      ...
      >
        <div className="flex flex-col items-center text-center gap-8">
          <h3 className="text-4xl font-semibold">Have a dream project?</h3>
        ...
        <div className="font-semibold text-[32px] px-12 py-6 rounded-full bg-black">
          Let's talk
        </div>
      </div>
    </main>

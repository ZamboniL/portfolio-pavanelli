const gradientText =
  "text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-violet-700 -from-40% to-white leading-[58px]";
export default function Statistics() {
  return (
    <div className="pt-24 w-full max-w-8xl flex">
      <div className="bg-zinc-900 rounded-[20px] flex flex-col items-center gap-12 px-8 md:px-9 py-5 md:flex-row md:w-full md:justify-between">

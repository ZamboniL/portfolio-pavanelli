  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5">
        ...
        <p className="font-medium leading-7 text-white/50">
          I have a passion for crafting unique and impactful logos that effectively communicate a{' '}
          {"brand's"} identity. With a focus on simplicity and memorability, I ensure that each logo
          I create leaves a lasting impression.
        </p>
      </div>
    </div>
  );
